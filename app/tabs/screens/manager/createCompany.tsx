...
export default function CreateCompany() {
    ...
    const createCompanyMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            Alert.alert('¡Empresa Creada!', 'Ahora crea tu primera sucursal.');
    ...
    return (
        ...
        >
            ...
            <TextInput 
                style={[style.input, { width: '100%', marginBottom: 15, borderWidth: 1, borderColor: style.text.color, borderRadius: 8 }]}
